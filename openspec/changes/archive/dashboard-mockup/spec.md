# Especificaciones: Dashboard & Core Features Mockup

**Relativo a**: `dashboard-mockup`
...
### 3. Maquetación Visual Premium
- **REQ-007**: Los componentes DEBEN seguir patrones modernos usando clases de Tailwind. Se usarán íconos de `lucide-react`.
